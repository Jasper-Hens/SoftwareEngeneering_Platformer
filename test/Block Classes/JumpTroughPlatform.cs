...
{
    // Implementeert IPlatform voor botsing alleen vanaf de bovenkant.
    public class JumpThroughPlatform : Block, IPlatform
    {
        // Source Rect voor Platform/Sprite 18: 325, 144, 64, 35
        private static readonly Rectangle SourceRect = new Rectangle(325, 144, 64, 35);
        private const int TILE_GRID_SIZE = 64;

        public JumpThroughPlatform(int gridX, int gridY, Texture2D texture)
        ...
        private static Rectangle CalculateWorldRect(int gridX, int gridY, int spriteWidth, int spriteHeight)
        {
            ...
            // Verschuif Y om de onderkant van de 35px sprite gelijk te laten lopen met de onderkant van de 64px cel.
